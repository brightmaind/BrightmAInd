...
const WebDesign: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Routine updates are completed within 1-2 business days for Starter and Growth plans, with priority response for Pro plans. Emergency support is available 24/7 for critical issues that affect site functionality."
    }
  ];
