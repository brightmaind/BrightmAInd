...
const LipEnhancement: React.FC = () => {
  ...
  return (
    <div className="pt-20 bg-charcoal text-off-white">
      <SEOHead 
        title="Lip Enhancement Funnel — Premium Consults on Demand | Bright mAInd"
        description="Package-led funnel that converts paid traffic into booked consults with deposit & reminders."
      ...
      <Breadcrumb items={[
        ...
        { name: 'Lip Enhancement', url: '/demos/lip-enhancement' }
      ]} />
        ...
        <section id="demo-hero" className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold font-rajdhani text-off-white mb-8">
              <span className="text-orange">Lip enhancement package</span> funnel (example)
            </h1>
            ...
            <div className="relative bg-near-black rounded-2xl p-8 mb-12">
              <div className="aspect-video bg-slate/20 rounded-lg flex items-center justify-center relative overflow-hidden">
                <video 
                  ...
                  poster="/assets/ads/lip.jpg"
                  muted
                  autoPlay
                  loop
                  playsInline
                >
                  <source src="/assets/ads/lip.mp4" type="video/mp4" />
