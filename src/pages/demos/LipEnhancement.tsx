...
const LipEnhancement: React.FC = () => {
  return (
    <div className="pt-20 bg-charcoal text-off-white">
      <SEOHead 
        title="Lip Enhancement Demo Funnel | Bright mAInd"
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div 
            id="demo-hero" 
            data-track="DemoView" 
            data-treatment="lip-enhancement"
          ...
          >
            <video
              ...
              loop
              playsInline
              poster="/assets/posters/lip-enhancement.jpg"
              className="w-full h-auto"
            >
              <source src="/assets/video/lip-enhancement.mp4" type="video/mp4" />
