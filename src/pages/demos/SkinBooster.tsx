...
const SkinBooster: React.FC = () => {
  ...
  return (
    <div className="pt-20 bg-charcoal text-off-white">
      <SEOHead 
        title="Skin Booster Funnel — Recurring Bookings & Retention | Bright mAInd"
        description="Series-based funnel built for recurring bookings and maintenance rebooking."
      ...
      <Breadcrumb items={[
        ...
        { name: 'Skin Booster', url: '/demos/skin-booster' }
      ]} />
        ...
        <section id="demo-hero" className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold font-rajdhani text-off-white mb-8">
              <span className="text-orange">Skin booster series</span> funnel (example)
            </h1>
            ...
            <div className="relative bg-near-black rounded-2xl p-8 mb-12">
              <div className="aspect-video bg-slate/20 rounded-lg flex items-center justify-center relative overflow-hidden">
                <video 
                  ...
                  poster="/assets/ads/skin.jpg"
                  muted
                  autoPlay
                  loop
                  playsInline
                >
                  <source src="/assets/ads/skin.mp4" type="video/mp4" />
