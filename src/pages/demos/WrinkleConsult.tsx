...
const WrinkleConsult: React.FC = () => {
  const handleBookAudit = () => {
    if (window.Calendly) {
      window.Calendly.initPopupWidget({
        url: 'https://calendly.com/enquiries-brightmaind/30min?a1=Wrinkle%20Consult%20Demo%20Audit',
      ...
      setTimeout(() => {
        ...
        if (popup && !popup.querySelector('.calendly-text-overlay')) {
          ...
          textOverlay.innerHTML = '<span>Let\'s discuss how this wrinkle consult funnel can work for your clinic</span>';
          popup.appendChild(textOverlay);
        }
      }, 100);
    } else {
      window.open('https://calendly.com/enquiries-brightmaind/30min?a1=Wrinkle%20Consult%20Demo%20Audit', '_blank');
    }
  };
  ...
  return (
    <div className="pt-20 bg-charcoal text-off-white">
      <SEOHead 
        title="Wrinkle Consult Demo Funnel | Bright mAInd"
        description="Demo funnel for wrinkle treatment consultations with deposit collection and automated reminders."
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div 
            id="demo-hero" 
            data-track="DemoView" 
            data-treatment="wrinkle-consult"
          ...
          >
            <video
              ...
              loop
              playsInline
              poster="/assets/posters/wrinkle-consult.jpg"
              className="w-full h-auto"
            >
              <source src="/assets/video/wrinkle-consult.mp4" type="video/mp4" />
