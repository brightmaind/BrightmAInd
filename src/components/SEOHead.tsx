...
const SEOHead: React.FC<SEOHeadProps> = ({ title, description, canonical, structuredData }) => {
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image:alt" content="BrightBox — on-premise AI appliance for manufacturing by BrightMaind" />
      ...
      <meta name="twitter:image:alt" content="BrightBox — on-premise AI appliance for manufacturing by BrightMaind" />
